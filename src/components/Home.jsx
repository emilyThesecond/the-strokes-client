...
const Home = () => {
  return (
    ...
    <div><iframe  src="https://www.youtube.com/embed/pjmaj-wtAPs" title="The Strokes - I&#39;ll Try Anything Once (&quot;You Only Live Once&quot; demo) (Heart In a Cage B-side)" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe></div>
    </div>
  )
}
